...
public class NavigationPaneHeader extends HLayout {
  ...
  public NavigationPaneHeader() {
    ...
    navigationPaneHeaderLabel.setContents(bookingSystem.getConstants().Workplace()); 
    ...
    contextAreaHeaderLabel.setContents(bookingSystem.getConstants().Activities()); 
    contextAreaHeaderLabel.setWidth("85%");
