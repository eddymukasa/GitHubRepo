...
public class ApplicationContextProvider implements ApplicationContextAware {
	...
	// com.planetsystems.procnet.core.security.util.ApplicationContextProvider
	...
	public void setApplicationContext(ApplicationContext applicationContext)
		...
		ApplicationPropertyPlaceHolderConfigurer propertyConfigurer = getBean(ApplicationPropertyPlaceHolderConfigurer.class);
		if (propertyConfigurer != null)
			applicationProperties = propertyConfigurer
